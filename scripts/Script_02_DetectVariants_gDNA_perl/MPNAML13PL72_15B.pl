...
#
#my $coords_file = '/t1-data/project/meadlab/arodrigu/MPNAML/scGenotyping/gPRIMERS_p53MPNAML.bed';
#my $bam_dir = '/t1-data/project/meadlab/arodrigu/MPNAML/scGenotyping/BWA/';
#my $out_dir = '/t1-data/project/meadlab/arodrigu/MPNAML/scGenotyping/gDNA_filter_v2/';

my $coords_file = '/project/meadlab/wwen/Vladimir/Metadata/gPRIMERS_p53MPNAML.bed';
my $bam_dir = '/project/meadlab/wwen/Vladimir/GST010/MPNAML13PL72_15B/gDNA/';
my $out_dir = '/project/meadlab/wwen/Vladimir/GST010/MPNAML13PL72_15B/gDNA/';
...
foreach my $file (@files)
{
	...
	while (<PIPE>)
	{
		...
		foreach my $from_coord (keys %{$coords{$ref_seq}})
		{
			...
			#my $len_primer = ($to_coord - $from_coord);
