...
mkdir -p /project/meadlab/wwen/Vladimir/GST010/MPNAML13PL71_13J/gDNA/
cd /project/meadlab/wwen/Vladimir/GST010/MPNAML13PL71_13J/gDNA/
...
bwa mem /project/meadlab/wwen/References/GRCh37_GENCODE_genome_sorted_bwa_indexed/GRCh37.primary_assembly.genome.fa \
        /t1-data/project/meadlab/arodrigu/MPNAML/scGenotyping/fastq/final/MPNAML13PL71_13J_R1.fq.gz \
        /t1-data/project/meadlab/arodrigu/MPNAML/scGenotyping/fastq/final/MPNAML13PL71_13J_R2.fq.gz > \
        MPNAML13PL71_13J_bwa_aligned.sam \
        -t 4

# Convert SAM to BAM
samtools view -bS -o MPNAML13PL71_13J_bwa_aligned.bam \
                     MPNAML13PL71_13J_bwa_aligned.sam \
                     -@ 4
	
# Sort by coordinates
samtools sort    MPNAML13PL71_13J_bwa_aligned.bam \
...
rm -rf MPNAML13PL71_13J_bwa_aligned.sam
rm -rf MPNAML13PL71_13J_bwa_aligned.bam

# Retrieve gDNA reads
perl /project/meadlab/wwen/Vladimir/Scripts/Scripts_01_GST010/Script_02_DetectVariants_gDNA_perl/MPNAML13PL71_13J.pl
...
gatk Mutect2 -R /project/meadlab/wwen/References/GRCh37_GENCODE_genome_sorted_bwa_indexed/GRCh37.primary_assembly.genome.fa \
             ...
             --bam-output MPNAML13PL71_13J.haplotype.bam
...
samtools mpileup --count-orphans \
                 ...
                 MPNAML13PL71_13J.RGAssignedsorted.DupMarked.genome.bam
...
bedtools coverage -counts \
                  ...
                  -b MPNAML13PL71_13J.RGAssignedsorted.DupMarked.genome.bam > \
