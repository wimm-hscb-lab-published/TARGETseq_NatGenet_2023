...
mkdir -p /project/meadlab/wwen/Vladimir/GST010/MPNAML13PL73_21N/mRNA/
cd /project/meadlab/wwen/Vladimir/GST010/MPNAML13PL73_21N/mRNA/
...
STAR --runThreadN 4 \
     ...
     --readFilesIn /t1-data/project/meadlab/arodrigu/MPNAML/scGenotyping/fastq/final/MPNAML13PL73_21N_R1.fq.gz /t1-data/project/meadlab/arodrigu/MPNAML/scGenotyping/fastq/final/MPNAML13PL73_21N_R2.fq.gz \
     --readFilesCommand zcat \
     --outFileNamePrefix /project/meadlab/wwen/Vladimir/GST010/MPNAML13PL73_21N/mRNA/MPNAML13PL73_21N. \
     --outTmpDir /project/meadlab/wwen/Vladimir/GST010/MPNAML13PL73_21N/mRNA/MPNAML13PL73_21N \
     --outReadsUnmapped Fastx \
     --limitBAMsortRAM 10000000000 \
     --outSAMtype BAM Unsorted

# Sort by coordinates
samtools sort MPNAML13PL73_21N.Aligned.out.bam \
...
rm -rf MPNAML13PL73_21N.Aligned.out.bam
rm -rf MPNAML13PL73_21N.Log.final.out
rm -rf MPNAML13PL73_21N.Log.out
rm -rf MPNAML13PL73_21N.Log.progress.out
rm -rf MPNAML13PL73_21N.SJ.out.tab
rm -rf MPNAML13PL73_21Ntmp.fifo.read1
rm -rf MPNAML13PL73_21Ntmp.fifo.read2
rm -rf MPNAML13PL73_21N.Unmapped.out.mate1
rm -rf MPNAML13PL73_21N.Unmapped.out.mate2

# Retrieve mRNA reads
perl /project/meadlab/wwen/Vladimir/Scripts/Scripts_01_GST010/Script_03_DetectVariants_mRNA_perl/MPNAML13PL73_21N.pl
...
gatk SplitNCigarReads -R /project/meadlab/wwen/References/GRCh37_GENCODE_genome/GRCh37.primary_assembly.genome.fa \
                  ...
                  -O MPNAML13PL73_21N.RGAssignedsorted.DupMark.HardClipped.bam
...
gatk Mutect2 -R /project/meadlab/wwen/References/GRCh37_GENCODE_genome/GRCh37.primary_assembly.genome.fa \
             ...
             -I MPNAML13PL73_21N.RGAssignedsorted.DupMark.HardClipped.bam \
...
samtools mpileup --count-orphans \
                 ...
                 MPNAML13PL73_21N.RGAssignedsorted.DupMark.HardClipped.bam
...
bedtools coverage -counts \
             ...
             -b MPNAML13PL73_21N.RGAssignedsorted.DupMark.HardClipped.bam > \
...
rm -rf MPNAML13PL73_21N.RGAssignedsorted.DupMarked.genome.bam
rm -rf MPNAML13PL73_21N.RGAssignedsorted.DupMarked.genome.bai
