...
mkdir -p /project/meadlab/wwen/Vladimir/GST010/MPNAML13PL64_11M/mRNA/
cd /project/meadlab/wwen/Vladimir/GST010/MPNAML13PL64_11M/mRNA/
...
STAR --runThreadN 4 \
     ...
     --readFilesIn /t1-data/project/meadlab/arodrigu/MPNAML/scGenotyping/fastq/final/MPNAML13PL64_11M_R1.fq.gz /t1-data/project/meadlab/arodrigu/MPNAML/scGenotyping/fastq/final/MPNAML13PL64_11M_R2.fq.gz \
     --readFilesCommand zcat \
     --outFileNamePrefix /project/meadlab/wwen/Vladimir/GST010/MPNAML13PL64_11M/mRNA/MPNAML13PL64_11M. \
     --outTmpDir /project/meadlab/wwen/Vladimir/GST010/MPNAML13PL64_11M/mRNA/MPNAML13PL64_11M \
     --outReadsUnmapped Fastx \
     --limitBAMsortRAM 10000000000 \
     --outSAMtype BAM Unsorted

# Sort by coordinates
samtools sort MPNAML13PL64_11M.Aligned.out.bam \
...
rm -rf MPNAML13PL64_11M.Aligned.out.bam
rm -rf MPNAML13PL64_11M.Log.final.out
rm -rf MPNAML13PL64_11M.Log.out
rm -rf MPNAML13PL64_11M.Log.progress.out
rm -rf MPNAML13PL64_11M.SJ.out.tab
rm -rf MPNAML13PL64_11Mtmp.fifo.read1
rm -rf MPNAML13PL64_11Mtmp.fifo.read2
rm -rf MPNAML13PL64_11M.Unmapped.out.mate1
rm -rf MPNAML13PL64_11M.Unmapped.out.mate2

# Retrieve mRNA reads
perl /project/meadlab/wwen/Vladimir/Scripts/Scripts_01_GST010/Script_03_DetectVariants_mRNA_perl/MPNAML13PL64_11M.pl
...
gatk SplitNCigarReads -R /project/meadlab/wwen/References/GRCh37_GENCODE_genome/GRCh37.primary_assembly.genome.fa \
                  ...
                  -O MPNAML13PL64_11M.RGAssignedsorted.DupMark.HardClipped.bam
...
gatk Mutect2 -R /project/meadlab/wwen/References/GRCh37_GENCODE_genome/GRCh37.primary_assembly.genome.fa \
             ...
             -I MPNAML13PL64_11M.RGAssignedsorted.DupMark.HardClipped.bam \
...
samtools mpileup --count-orphans \
                 ...
                 MPNAML13PL64_11M.RGAssignedsorted.DupMark.HardClipped.bam
...
bedtools coverage -counts \
             ...
             -b MPNAML13PL64_11M.RGAssignedsorted.DupMark.HardClipped.bam > \
...
rm -rf MPNAML13PL64_11M.RGAssignedsorted.DupMarked.genome.bam
rm -rf MPNAML13PL64_11M.RGAssignedsorted.DupMarked.genome.bai
