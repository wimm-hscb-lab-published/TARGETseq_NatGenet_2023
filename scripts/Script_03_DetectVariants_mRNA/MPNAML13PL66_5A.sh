...
mkdir -p /project/meadlab/wwen/Vladimir/GST010/MPNAML13PL66_5A/mRNA/
cd /project/meadlab/wwen/Vladimir/GST010/MPNAML13PL66_5A/mRNA/
...
STAR --runThreadN 4 \
     ...
     --readFilesIn /t1-data/project/meadlab/arodrigu/MPNAML/scGenotyping/fastq/final/MPNAML13PL66_5A_R1.fq.gz /t1-data/project/meadlab/arodrigu/MPNAML/scGenotyping/fastq/final/MPNAML13PL66_5A_R2.fq.gz \
     --readFilesCommand zcat \
     --outFileNamePrefix /project/meadlab/wwen/Vladimir/GST010/MPNAML13PL66_5A/mRNA/MPNAML13PL66_5A. \
     --outTmpDir /project/meadlab/wwen/Vladimir/GST010/MPNAML13PL66_5A/mRNA/MPNAML13PL66_5A \
     --outReadsUnmapped Fastx \
     --limitBAMsortRAM 10000000000 \
     --outSAMtype BAM Unsorted

# Sort by coordinates
samtools sort MPNAML13PL66_5A.Aligned.out.bam \
...
rm -rf MPNAML13PL66_5A.Aligned.out.bam
rm -rf MPNAML13PL66_5A.Log.final.out
rm -rf MPNAML13PL66_5A.Log.out
rm -rf MPNAML13PL66_5A.Log.progress.out
rm -rf MPNAML13PL66_5A.SJ.out.tab
rm -rf MPNAML13PL66_5Atmp.fifo.read1
rm -rf MPNAML13PL66_5Atmp.fifo.read2
rm -rf MPNAML13PL66_5A.Unmapped.out.mate1
rm -rf MPNAML13PL66_5A.Unmapped.out.mate2

# Retrieve mRNA reads
perl /project/meadlab/wwen/Vladimir/Scripts/Scripts_01_GST010/Script_03_DetectVariants_mRNA_perl/MPNAML13PL66_5A.pl
...
gatk SplitNCigarReads -R /project/meadlab/wwen/References/GRCh37_GENCODE_genome/GRCh37.primary_assembly.genome.fa \
                  ...
                  -O MPNAML13PL66_5A.RGAssignedsorted.DupMark.HardClipped.bam
...
gatk Mutect2 -R /project/meadlab/wwen/References/GRCh37_GENCODE_genome/GRCh37.primary_assembly.genome.fa \
             ...
             -I MPNAML13PL66_5A.RGAssignedsorted.DupMark.HardClipped.bam \
...
samtools mpileup --count-orphans \
                 ...
                 MPNAML13PL66_5A.RGAssignedsorted.DupMark.HardClipped.bam
...
bedtools coverage -counts \
             ...
             -b MPNAML13PL66_5A.RGAssignedsorted.DupMark.HardClipped.bam > \
...
rm -rf MPNAML13PL66_5A.RGAssignedsorted.DupMarked.genome.bam
rm -rf MPNAML13PL66_5A.RGAssignedsorted.DupMarked.genome.bai
