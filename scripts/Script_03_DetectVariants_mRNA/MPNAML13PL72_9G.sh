...
mkdir -p /project/meadlab/wwen/Vladimir/GST010/MPNAML13PL72_9G/mRNA/
cd /project/meadlab/wwen/Vladimir/GST010/MPNAML13PL72_9G/mRNA/
...
STAR --runThreadN 4 \
     ...
     --readFilesIn /t1-data/project/meadlab/arodrigu/MPNAML/scGenotyping/fastq/final/MPNAML13PL72_9G_R1.fq.gz /t1-data/project/meadlab/arodrigu/MPNAML/scGenotyping/fastq/final/MPNAML13PL72_9G_R2.fq.gz \
     --readFilesCommand zcat \
     --outFileNamePrefix /project/meadlab/wwen/Vladimir/GST010/MPNAML13PL72_9G/mRNA/MPNAML13PL72_9G. \
     --outTmpDir /project/meadlab/wwen/Vladimir/GST010/MPNAML13PL72_9G/mRNA/MPNAML13PL72_9G \
     --outReadsUnmapped Fastx \
     --limitBAMsortRAM 10000000000 \
     --outSAMtype BAM Unsorted

# Sort by coordinates
samtools sort MPNAML13PL72_9G.Aligned.out.bam \
...
rm -rf MPNAML13PL72_9G.Aligned.out.bam
rm -rf MPNAML13PL72_9G.Log.final.out
rm -rf MPNAML13PL72_9G.Log.out
rm -rf MPNAML13PL72_9G.Log.progress.out
rm -rf MPNAML13PL72_9G.SJ.out.tab
rm -rf MPNAML13PL72_9Gtmp.fifo.read1
rm -rf MPNAML13PL72_9Gtmp.fifo.read2
rm -rf MPNAML13PL72_9G.Unmapped.out.mate1
rm -rf MPNAML13PL72_9G.Unmapped.out.mate2

# Retrieve mRNA reads
perl /project/meadlab/wwen/Vladimir/Scripts/Scripts_01_GST010/Script_03_DetectVariants_mRNA_perl/MPNAML13PL72_9G.pl
...
gatk SplitNCigarReads -R /project/meadlab/wwen/References/GRCh37_GENCODE_genome/GRCh37.primary_assembly.genome.fa \
                  ...
                  -O MPNAML13PL72_9G.RGAssignedsorted.DupMark.HardClipped.bam
...
gatk Mutect2 -R /project/meadlab/wwen/References/GRCh37_GENCODE_genome/GRCh37.primary_assembly.genome.fa \
             ...
             -I MPNAML13PL72_9G.RGAssignedsorted.DupMark.HardClipped.bam \
...
samtools mpileup --count-orphans \
                 ...
                 MPNAML13PL72_9G.RGAssignedsorted.DupMark.HardClipped.bam
...
bedtools coverage -counts \
             ...
             -b MPNAML13PL72_9G.RGAssignedsorted.DupMark.HardClipped.bam > \
...
rm -rf MPNAML13PL72_9G.RGAssignedsorted.DupMarked.genome.bam
rm -rf MPNAML13PL72_9G.RGAssignedsorted.DupMarked.genome.bai
