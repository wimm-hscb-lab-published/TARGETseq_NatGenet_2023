...
mkdir -p /project/meadlab/wwen/Vladimir/GST010/MPNAML13PL71_5M/mRNA/
cd /project/meadlab/wwen/Vladimir/GST010/MPNAML13PL71_5M/mRNA/
...
STAR --runThreadN 4 \
     ...
     --readFilesIn /t1-data/project/meadlab/arodrigu/MPNAML/scGenotyping/fastq/final/MPNAML13PL71_5M_R1.fq.gz /t1-data/project/meadlab/arodrigu/MPNAML/scGenotyping/fastq/final/MPNAML13PL71_5M_R2.fq.gz \
     --readFilesCommand zcat \
     --outFileNamePrefix /project/meadlab/wwen/Vladimir/GST010/MPNAML13PL71_5M/mRNA/MPNAML13PL71_5M. \
     --outTmpDir /project/meadlab/wwen/Vladimir/GST010/MPNAML13PL71_5M/mRNA/MPNAML13PL71_5M \
     --outReadsUnmapped Fastx \
     --limitBAMsortRAM 10000000000 \
     --outSAMtype BAM Unsorted

# Sort by coordinates
samtools sort MPNAML13PL71_5M.Aligned.out.bam \
...
rm -rf MPNAML13PL71_5M.Aligned.out.bam
rm -rf MPNAML13PL71_5M.Log.final.out
rm -rf MPNAML13PL71_5M.Log.out
rm -rf MPNAML13PL71_5M.Log.progress.out
rm -rf MPNAML13PL71_5M.SJ.out.tab
rm -rf MPNAML13PL71_5Mtmp.fifo.read1
rm -rf MPNAML13PL71_5Mtmp.fifo.read2
rm -rf MPNAML13PL71_5M.Unmapped.out.mate1
rm -rf MPNAML13PL71_5M.Unmapped.out.mate2

# Retrieve mRNA reads
perl /project/meadlab/wwen/Vladimir/Scripts/Scripts_01_GST010/Script_03_DetectVariants_mRNA_perl/MPNAML13PL71_5M.pl
...
gatk SplitNCigarReads -R /project/meadlab/wwen/References/GRCh37_GENCODE_genome/GRCh37.primary_assembly.genome.fa \
                  ...
                  -O MPNAML13PL71_5M.RGAssignedsorted.DupMark.HardClipped.bam
...
gatk Mutect2 -R /project/meadlab/wwen/References/GRCh37_GENCODE_genome/GRCh37.primary_assembly.genome.fa \
             ...
             -I MPNAML13PL71_5M.RGAssignedsorted.DupMark.HardClipped.bam \
...
samtools mpileup --count-orphans \
                 ...
                 MPNAML13PL71_5M.RGAssignedsorted.DupMark.HardClipped.bam
...
bedtools coverage -counts \
             ...
             -b MPNAML13PL71_5M.RGAssignedsorted.DupMark.HardClipped.bam > \
...
rm -rf MPNAML13PL71_5M.RGAssignedsorted.DupMarked.genome.bam
rm -rf MPNAML13PL71_5M.RGAssignedsorted.DupMarked.genome.bai
